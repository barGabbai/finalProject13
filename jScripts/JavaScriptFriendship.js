...
$(document).ready(function () {
    ...
    $("#img1InnerNav2-2").click(function () {
        $('html, body').animate({
            scrollTop: $("#dykFriendship").offset().top - 620
        }, 500);
    });

    $("#img2InnerNav2-2").click(function () {
        $('html, body').animate({
            scrollTop: $("#assistanceFriendship").offset().top - 420
        }, 500);
    });

    var topOfdykFriendshipDiv = $("#dykFriendship").offset().top - 620;
    var topOfassistanceFriendshipDiv = $("#assistanceFriendship").offset().top - 520;
