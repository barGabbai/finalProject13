...
$(document).ready(function () {
    ...
    $("#img1Nav2").click(function () {
        $('html, body').animate({
            scrollTop: $("#historyPage").offset().top-420
        }, 700);
    });

    $("#img2Nav2").click(function () {
        $('html, body').animate({
            scrollTop: $("#whoAreWePage").offset().top - 470
        }, 700);
    });

    $("#img3Nav2").click(function () {
        $('html, body').animate({
            scrollTop: $("#numbersPage").offset().top - 470
        }, 700);
    });

    $("#img4Nav2").click(function () {
        $('html, body').animate({
            scrollTop: $("#sayingPage").offset().top - 470
        }, 700);
    });

    $("#img5Nav2").click(function () {
        $('html, body').animate({
            scrollTop: $("#contactPage").offset().top - 620
        }, 700);
    });
