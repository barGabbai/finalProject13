...
$(document).ready(function () {
    ...
    $("#img1InnerNav2-1").click(function () {
        $('html, body').animate({
            scrollTop: $("#dykCareer").offset().top - 620
        }, 500);
    });

    $("#img2InnerNav2-1").click(function () {
        $('html, body').animate({
            scrollTop: $("#assistanceCareer").offset().top - 420
        }, 500);
    });

    var topOfdykCareeryDiv = $("#dykCareer").offset().top - 620;
    var topOfassistanceCareereDiv = $("#assistanceCareer").offset().top - 520;

    $(window).scroll(function () {
        if ($(window).scrollTop() > topOfdykCareeryDiv) { //scrolled past the other div?
            $("#img1InnerNav2-1").css('opacity', '0'); //reached the desired point -- show div

            $("#img2InnerNav2-1").css('opacity', '1');
        }

        if ($(window).scrollTop() > topOfassistanceCareereDiv) { //scrolled past the other div?
